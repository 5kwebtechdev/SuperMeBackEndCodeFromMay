...
//    // ------------------- Relations -------------------
//
//    @OneToMany(mappedBy = "tutorId", cascade = CascadeType.ALL, orphanRemoval = true)
//    @JsonIgnore
//    @Builder.Default
...
//    }
//}
////    public enum Experience { FRESHER, PLUS_1, PLUS_2, PLUS_5, PLUS_8, PLUS_10 }
//// ================= EXPERIENCE =================
...
//    }
//}
////    public enum EntityType { SCHOOL, COLLEGE, TUITION, UNIVERSITY, INSTITUTE, SELF, INDIVIDUAL, ACADEMY }
//// ================= ENTITY TYPE =================
...
//    }
//}
////    public enum Subject { MATHEMATICS, SCIENCE, ENGLISH, PHYSICS, CHEMISTRY, BIOLOGY }
//// ================= SUBJECT =================
//public enum Subject {
...
//    }
//}
////    public enum Availability { MONDAY, TUESDAY, WEDNESDAY, THURSDAY, FRIDAY, SATURDAY, SUNDAY }
//// ================= AVAILABILITY =================
...
//    }
//}
////    public enum ContactMode { VIDEO_CALL, PHONE_CALL, IN_PERSON, ONLINE_CHAT, HYBRID }
//
//    // ================= CONTACT MODE =================
